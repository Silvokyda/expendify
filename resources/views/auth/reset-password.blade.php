...
<head>
    ...
    <title>Expendify — Reset Password</title>
...
<div class="grid lg:grid-cols-2 min-h-screen">
    ...
    <main id="main" class="relative flex items-center justify-center px-4 sm:px-6 lg:px-10 py-10">
        <div class="w-full max-w-md">
            ...
            <h1 class="mt-8 text-3xl font-semibold tracking-tight">Reset your password</h1>
    ...
    <aside class="relative hidden lg:flex items-center justify-center">
        ...
        <div class="mx-auto max-w-xl">
            <div class="rounded-2xl bg-white/10 dark:bg-white/5 backdrop-blur-xl border border-white/20 shadow-xl p-6">
                <h2 class="text-2xl font-semibold leading-tight">Choose a strong password</h2>
                <ul class="mt-4 space-y-2 text-sm text-white/90">
                    <li class="flex items-start gap-2"><span class="mt-1 h-1.5 w-1.5 rounded-full bg-white/70"></span> At least 8 characters long</li>
                    <li class="flex items-start gap-2"><span class="mt-1 h-1.5 w-1.5 rounded-full bg-white/70"></span> Mix letters, numbers & symbols</li>
                    <li class="flex items-start gap-2"><span class="mt-1 h-1.5 w-1.5 rounded-full bg-white/70"></span> Don’t reuse old passwords</li>
                </ul>
                <p class="mt-3 text-[11px] text-white/60">Your security is our priority.</p>
            </div>
        </div>
    </aside>
</div>
